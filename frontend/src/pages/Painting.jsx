...
const Painters = () => {
  const services = [
    { id: 1, name: "دهان داخلي", desc: "طلاء الجدران الداخلية بجميع الألوان", status: "متاح" },
    { id: 2, name: "دهان خارجي", desc: "دهان واجهات المنازل والمباني", status: "متاح" },
    { id: 3, name: "ديكورات", desc: "أعمال دهان ديكوري مميزة", status: "غير متاح" },
  ];
