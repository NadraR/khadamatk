...
const Carpenters = () => {
  const services = [
    { id: 1, name: "تصنيع أثاث", desc: "صناعة الأثاث حسب الطلب", status: "متاح" },
    { id: 2, name: "إصلاح أبواب", desc: "إصلاح وتركيب الأبواب والنوافذ", status: "متاح" },
    { id: 3, name: "مطابخ خشب", desc: "تصميم وتنفيذ مطابخ خشبية", status: "غير متاح" },
  ];
