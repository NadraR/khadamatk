...
const Gardening = () => {
  const services = [
    { id: 1, name: "قص النجيلة", desc: "قص وتنسيق الحدائق", status: "متاح" },
    { id: 2, name: "زراعة نباتات", desc: "زراعة الأشجار والزهور", status: "متاح" },
    { id: 3, name: "تنسيق حدائق", desc: "تصميم وتنسيق الحدائق", status: "غير متاح" },
  ];
